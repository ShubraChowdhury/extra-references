...
print("zero_idx =",len(zero_idx),len(non_zero_idx))
...
reviews_ints = [reviews_ints[idx_ri] for idx_ri in non_zero_idx]
labels = np.array([labels[idx_lbl] for idx_lbl in non_zero_idx])
