# -*- coding: utf-8 -*-
"""
Created on Sun Aug  6 16:46:26 2017
...
#    y_hat =sigmoid(np.matmul(X,W)+b)
    ...
    Derivate_of_errors= dErrors(X, y, y_hat)
    #print(sum(Derivate_of_errors[0]))
    #print(Derivate_of_errors[0])
    #print(Derivate_of_errors[2])
    #print(sum(Derivate_of_errors[2]))
    # TODO: Update the weights
    W[0] = W[0] + sum(Derivate_of_errors[0])*learn_rate
    W[1] = W[1] + sum(Derivate_of_errors[1])*learn_rate
    b = b + sum(Derivate_of_errors[2])*learn_rate
